												...
												<div class="modal fade" id="userInfo" role="dialog">
													<div class="modal-dialog">
														<div class="modal-content" style="border-radius: 1px">
															...
															<button class="btn btn-default"	ng-click="addQuestions(newUser)"
																		style="margin-bottom: 5px;"><i class="fa fa-2 fa-plus"></i></button><br>
																<div ng-repeat="(index, q) in newUser.questions">
																	<span>Câu
																		hỏi:</span>
